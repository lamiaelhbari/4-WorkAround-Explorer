...
- Rendering radio buttons using the salaryData module.
- Creating the workAroundModule.
- Calculating and rendering data when the user input changes.
- Extra Challenge: Creating a new file called utilities.js in the modules/ directory.
Defining and exporting a function called formatNumber() in utilities.js. 
This function takes a number parameter and returns a string representation of that
number value with a comma (,) character between every 3rd digit. 
Importing this function into main.js and using it to format the four data values 
